...
2. [Development Tools & IDEs](#2-development-tools--ides)
3. [Cloud Services & Hosting](#3-cloud-services--hosting)
4. [Databases](#4-databases)
5. [Design Tools](#5-design-tools)
6. [Learning Platforms & Certifications](#6-learning-platforms--certifications)
7. [Productivity Tools](#7-productivity-tools)
...
The Pack is the gateway service. Apply first, then redeem individual benefits.

**How to apply:** https://education.github.com/pack
- Requires `.edu.tw` email added to GitHub account
- Upload student ID or enrollment certificate
- Approval: usually 3-7 days (sometimes instant for `.edu.tw`)

### Pack Benefits

| ID | Service | What You Get | Value | URL |
|----|---------|-------------|-------|-----|
| copilot | GitHub Copilot | AI code assistant, free during enrollment | ~$120/yr | https://github.com/settings/copilot |
| github-pro | GitHub Pro | Unlimited private repos, 3000 Actions min/mo, 180h Codespaces | ~$48/yr | (auto-enabled) |
| gitkraken | GitKraken Pro | Professional Git GUI client | ~$60/yr | https://www.gitkraken.com/github-student-developer-pack |
| educative | Educative | 6 months free, 70+ interactive courses | ~$150 | https://education.github.com/pack |
| frontendmasters | Frontend Masters | 6 months free, all courses | ~$234 | https://frontendmasters.com/welcome/github-student-developers/ |
| 1password | 1Password | Personal account free 1 year, SSH/Git integration | ~$36 | https://1password.com/developers/students |
| digitalocean | DigitalOcean | $200 cloud credits, 1 year validity | $200 | https://www.digitalocean.com/github-students |
| mongodb | MongoDB Atlas | $50 credits + free certification | $50+ | https://www.mongodb.com/students |
| namecheap | Namecheap | .me domain 1 year + SSL certificate | ~$20 | https://nc.me/ |
| namecom | Name.com | Free domain 1 year (25+ TLD options) | ~$15 | https://www.name.com/partner/github-students |
| heroku | Heroku | $13/month credits x 24 months | $312 | https://www.heroku.com/github-students/ |
...
No GitHub Pack required. Apply independently.

| ID | Service | What You Get | Duration | URL |
|----|---------|-------------|----------|-----|
| jetbrains | JetBrains All IDEs | IntelliJ, WebStorm, PyCharm, etc. | 1 year (renewable) | https://www.jetbrains.com/community/education/#students |
| cursor | Cursor Pro | AI-powered code editor | 1 year (~$240 value) | https://cursor.com/students |
...
## 3. Cloud Services & Hosting

| ID | Service | What You Get | Duration | Credit Card? | URL |
|----|---------|-------------|----------|-------------|-----|
| azure | Microsoft Azure | $100 credit + 25 free services | 12 months | No | https://azure.microsoft.com/en-us/free/students/ |
| aws-educate | AWS Educate | Free labs + $25-100 credits | Varies | No | https://aws.amazon.com/education/awseducate/ |
| gcloud | Google Cloud | $300 free credits | 12 months | Yes (new users) | https://cloud.google.com/edu/students |
| netlify | Netlify | Free Starter (100GB bandwidth/mo) | Permanent | No | https://www.netlify.com/ |
| oracle | Oracle Cloud Free Tier | 2 ARM VMs + 24GB RAM (Always Free) | Permanent | Yes (no charges) | https://www.oracle.com/tw/cloud/free/ |

**Notes:**
- Azure is the best starting point: no credit card, `.edu.tw` eligible
- Google Cloud GDSC membership provides additional credits
- Oracle Always Free tier is genuinely permanent
...
| ID | Service | What You Get | Duration | URL |
|----|---------|-------------|----------|-----|
| supabase | Supabase | 500MB DB, 1GB storage, 50K MAU auth | Permanent free tier | https://supabase.com/pricing |
| neon | Neon | 0.5GB storage, 190h active compute | Permanent free tier | https://neon.tech/pricing |
...
| ID | Service | What You Get | Duration | URL |
|----|---------|-------------|----------|-----|
| figma | Figma Education | Professional plan free | 2 years | https://www.figma.com/education/ |
| autodesk | Autodesk Education | AutoCAD, Maya, Fusion 360, full suite | 1 year (renewable) | https://www.autodesk.com/education/edu-software/overview |
| miro | Miro Education | Education plan free | During enrollment | https://miro.com/education/ |
| blender | Blender | Full 3D suite (open-source) | Permanent | https://www.blender.org/download/ |
...
## 6. Learning Platforms & Certifications

| ID | Service | What You Get | Cost | URL |
|----|---------|-------------|------|-----|
| coursera | Coursera Financial Aid | Most courses nearly free | Apply per course | https://www.coursera.org/apply-for-aid |
| edx | edX | Free audit access to MIT/Harvard courses | Free | https://www.edx.org/ |
| kaggle | Kaggle Learn | Python, SQL, ML courses + certs | Free | https://www.kaggle.com/learn |
| ms-learn | Microsoft Learn | Full learning paths, Traditional Chinese UI | Free | https://learn.microsoft.com/zh-tw |
| gdsc | Google DSC | Free membership + Google resources | Free | https://developers.google.com/community/gdsc |
| htb | Hack The Box | Starting Point + some active machines | Free (partial) | https://www.hackthebox.com/ |
| thm | TryHackMe | Student discount on Premium | Discounted | https://tryhackme.com/ |
| hackerrank | HackerRank | Skills verification certs (Python, Java, SQL, JS) | Free | https://www.hackerrank.com/skills-verification |
| ibm-skills | IBM SkillsBuild | AI, cloud, cybersecurity courses | Free | https://skillsbuild.org/students |

**Notes:**
- Coursera: Taiwan students have high financial aid approval rate
- GDSC: Taiwan universities include NTU, NYCU, NCKU, NCU, and more
- HackerRank certifications are recognized by employers
...
| ID | Service | What You Get | Duration | URL |
|----|---------|-------------|----------|-----|
| notion | Notion Plus | Plus plan free | During enrollment | https://www.notion.com/product/notion-for-education |
| ms365 | Microsoft 365 Education | Word, Excel, PowerPoint, Teams | During enrollment | https://www.microsoft.com/zh-tw/education/products/office |
| zoom | Zoom Education | Education plan (via school) | During enrollment | https://zoom.us/education |
| linear | Linear | Free plan + student discount | Varies | https://linear.app/pricing |
| clickup | ClickUp | Free Forever tier | Permanent | https://clickup.com/teams/student |
| loom | Loom | Premium via Atlassian Education | Varies | https://www.loom.com/education |
...
| ID | Service | What You Get | Duration | URL |
|----|---------|-------------|----------|-----|
| letsencrypt | Let's Encrypt | Free SSL/TLS certificates | Permanent (auto-renew) | https://letsencrypt.org/ |

Also see Namecheap and Name.com in the GitHub Pack section for free domains.
...
| ID | Service | What You Get | Duration | URL |
|----|---------|-------------|----------|-----|
| spotify | Spotify Student | ~50% off (NT$88/mo in Taiwan) | During enrollment (renew yearly) | https://www.spotify.com/tw/student/ |
| apple-music | Apple Music Student | ~50% student discount | During enrollment | https://music.apple.com/tw/subscribe |
...
| ID | Service | What You Get | Cost | URL |
|----|---------|-------------|------|-----|
| perplexity | Perplexity Pro | 50% off ($10/mo) | Discounted | https://perplexity.ai/students |
| gemini | Google Gemini | Access via school Google Workspace | Free (school-dependent) | https://workspace.google.com/solutions/education |
...
|---------|---------------|--------|
| GitHub Copilot | Auto-enabled on your GitHub account | You get **Copilot Student** (**not** Copilot Pro): unlimited code completions, but **auto model selection only — you cannot pick a model**, 8 models available, and an AI credit allowance GitHub does not publish. By comparison, paid Copilot Pro ($10/mo) lets you pick from 17 models with 1,500 credits. See README |
...
## Application Priority Guide

### Week 1: Foundation
1. GitHub Student Pack (gateway to 12+ services)
2. JetBrains (no Pack needed, instant)
3. Azure (no credit card, instant)
4. Figma Education (if design-related)
...
- Learning platforms (Coursera FA, Kaggle)
- Media discounts (Spotify, Apple Music)
- Remaining Pack benefits

### Total Estimated Value

| Category | Estimated Annual Value |
|----------|----------------------|
| GitHub Pack benefits | ~$2,200+ |
| Independent dev tools | ~$500+ |
| Cloud credits | ~$600+ |
| Design tools | ~$400+ |
| Productivity | ~$200+ |
| Learning (if paid) | ~$500+ |
| **Total** | **~$4,400+** |
